export const modules = [
  {
    ...
    source: 'lib/framework/Application.ts',
  ...
  },
  {
    id: 'http-routing',
    label: 'HTTP routing',
    source: 'lib/framework/HttpRouter.ts',
    related: ['test/unit/http-router.test.ts'],
    tests: ['test/unit/http-router.test.ts'],
    mutants: [
      {
  ...
  },
  {
    ...
    source: 'lib/framework/webSocketProtocol.ts',
    related: ['test/unit/websocket-protocol.test.ts'],
    tests: ['test/unit/websocket-protocol.test.ts'],
    mutants: [
      {
        id: 'fatal-error-code',
  ...
  },
  {
    ...
    source: 'lib/framework/WorkerPool.ts',
    related: ['test/unit/job-runner.test.ts', 'test/e2e/races.test.ts'],
    tests: ['test/unit/job-runner.test.ts'],
    mutants: [
      {
