...
import { createWebSocketRequestSender } from './webSocketRequestSender.js';
import {
...
export class Application {
  ...
  async #handleHttpRequest(request, response) {
    ...
    const ctx = Object.freeze({
      ...
      ...(authSession
        ? {
            webSocket: createWebSocketRequestSender(
 ...
 * аутентификации.
 * @property {HttpRequestWebSocketSender} [webSocket] Request-scoped WebSocket server-push
