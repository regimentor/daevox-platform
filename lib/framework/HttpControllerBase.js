 ...
 * through {@link Application#registerHttpController}. A fresh instance is created per request.
 * Подклассы должны объявить собственные статические поля `prefix` и `routes` и регистрироваться
 * через {@link Application#registerHttpController}. Для каждого запроса создаётся новый экземпляр.
 *
 * @public
 * @abstract
 */
