...
export TRANSCRIPTION_TTS_ENGINE=qwen
export TRANSCRIPTION_TTS_GPU='NVIDIA GeForce RTX 5080'
export TRANSCRIPTION_ASR_GPU='NVIDIA GeForce RTX 5080'
export TRANSCRIPTION_DIARIZATION_GPU='NVIDIA GeForce RTX 5080'
export TRANSCRIPTION_LLM_MODEL='Ornith-1.5-9B'
npm run dev --workspace @daevox/transcription-backend
```
